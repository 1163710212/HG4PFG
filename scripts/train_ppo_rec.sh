...
DATASET="KuaiRec"
setup_split_environment "KuaiRec" "KuaiRec" "user_KRMBUserResponse_lr0.0001_reg0_nlayer2" "run_multibehavior_rec.sh"
...
# policy args
POLICY_CLASS='OneStagePolicy_OnPolicy'
HA_VAR=0.1
HA_CLIP=1.0
COEF=0.01
...
do
    ...
    do
        ...
        do
            ...
            do
                for ACTOR_LR in 0.0001 # 0.0001, 0.00001
                do
                    for SEED in "${SEED:-12}"
                    do
